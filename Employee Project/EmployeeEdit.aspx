<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmployeeEdit.aspx.cs" Inherits="Employee_PR_01.EmployeeEdit" %>
...
<body>
    <form id="form1" runat="server" style="border: 2px solid; background-color: lightblue; margin: 80px auto; height: 400px; width: 600px; padding: 30px; border-radius: 30px">
        <div>
            ...
            <asp:TextBox ID="txtDesignation" runat="server" Style="border-radius: 5px;" placeholder="Enter Designation"></asp:TextBox>
            ...
            <asp:TextBox ID="txtSalary" runat="server" Style="border-radius: 5px;" placeholder="Only numbers"></asp:TextBox>
            ...
            <asp:Button ID="btnUpdate" runat="server" Text="Update" Style="border-radius: 5px; background-color: royalblue; border: none; width: 100px; padding: 5px; height: 40px" OnClick="btnUpdate_Click" />
            <br />
